        ...
        fetch(`https://api.github.com/repos/jrawsthorne/${repo.name}/commits`)
          ...
          .then(commits => {
            const mycommits = commits.filter(
              commit =>
                (commit.author && commit.author.login === "jrawsthorne") ||
                commit.name === "Jake Rawsthorne"
            );
            return {
              ...repo,
              commits: mycommits
      ...
      repos.forEach(repo => {
        ...
        div.innerHTML = `
          <h3>
            ...
            ${
              repo.homepage
                ? `<small><a href="${repo.homepage}">Visit site</a></small>`
                : ""
            }
          </h3>
          ${
        ...
        repo.commits.forEach(commit => {
          ...
          li.innerHTML = `<a href="${commit.html_url}">${
